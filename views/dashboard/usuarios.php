...
<div class="row">
    ...
    <div class="input-field center-align col s12 m4">
        ...
        <a href="../../app/reports/dashboard/empleados.php" target="_blank" class="btn waves-effect amber tooltipped" data-tooltip="Reporte de productos por categoría"><i class="material-icons">assignment</i></a>
    </div>
</div>
