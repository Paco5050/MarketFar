    ...
    public static function headerTemplate($title)
    {
        ...
        print('
            ...
            <html lang="es">
                <head>
                    <meta charset="utf-8">
                    <title>Marketfar Dashboard - ' . $title . '</title>
                            ...
                            <nav class="grey darken-4">
                                <div class="nav-wrapper">
                                    ...
                                    <ul class="right hide-on-med-and-down">
                                        <li><a href="ordenes.php"><i class="material-icons left">view_list</i>Ordenes</a></li>
                ...
                print('
                    <header>
                        <div class="navbar-fixed">
                            <nav class="grey darken-4">
                                <div class="nav-wrapper">
                                    <a href="index.php" class="brand-logo "><i class="material-icons margin">dashboard</i></a>
                                </div>
                            </nav>
                        </div>
                    </header>
