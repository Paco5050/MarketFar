...
function readAllCategorias() {
    fetch(API_CATALOGO + 'readAll', {
        ...
        // Se verifica si la petición es satisfactoria, de lo contrario se muestra un mensaje en consola indicando el problema.
        if (request.ok) {
            request.json().then(function (response) {
                ...
                if (response.status) {
                    ...
                    // Se presenta en el título del contenido un mensaje de error cuando no existen datos para mostrar.
