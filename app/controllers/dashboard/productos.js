        ...
        content += `
            <tr>
                ...
                <td>
                    ...
                    <a href="../../app/reports/dashboard/productos_categoria.php?id=${row.id_categoria}" target="_blank" class="btn waves-effect amber tooltipped" data-tooltip="Reporte de Venta"><i class="material-icons">assignment</i></a>
                </td>
            </tr>
        `;
    });
